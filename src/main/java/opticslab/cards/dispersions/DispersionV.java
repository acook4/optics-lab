...
public class DispersionV extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "DispersionV", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        Color violetC = Color.VIOLET.cpy();
        violetC.a = 0.5F;
        ColorSpotlightPlayerEffect violet = new ColorSpotlightPlayerEffect(violetC);
        AbstractDungeon.effectsQueue.add(violet);
