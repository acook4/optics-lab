...
import opticslab.util.GeneralUtils;
import opticslab.util.KeywordInfo;
import opticslab.util.TextureLoader;
...
public class BasicMod implements
    ...
    private static final String resourcesFolder = "opticslab";
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.addEvent(OpticsLab.ID, OpticsLab.class, TheCity.ID);
    }
